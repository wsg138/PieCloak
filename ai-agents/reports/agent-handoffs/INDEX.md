...
- `0000-coordination-bootstrap.md` — coordination bootstrap, package routing, review findings, and package 01 selection.
- `0001-20260805T201940Z-current-platform-baseline.md` — package 01 complete; Minecraft 1.21.11 build/CI baseline established; package 02 selected.
...
- `0010-20260806T044700Z-final-integration-release-review.md` — package 09 complete; unresolved-respawn metadata and duplicate invalidation fixed, intermediate compile regression repaired, exact final head validated, PR description cleaned, and the former owner-ready verdict issued.
- `0011-20260806T051806Z-codacy-provenance-review-reopen.md` — owner review found an unclassified Codacy action-required result; packages 10–11 added, the prior verdict superseded for Codacy, and package 10 selected.
- `0012-20260806T082300Z-package-10-complete.md` — package 10 complete; 573 findings classified as 390 upstream and 183 PieCloak, all PieCloak findings remediated, final export reduced to 376 upstream findings, and package 11 selected.
- `0013-20260806T132600Z-final-codacy-verification.md` — package 11 complete; provenance, remediation, exact-head validation, hostile review, and final zero-PieCloak finding result independently verified; repository routed to `READY_FOR_OWNER`.
